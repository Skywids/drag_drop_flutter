...
class _BoardListViewState extends State<BoardListView> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<BoardListModel>>(
      stream: _dataManager.getStream(),
  ...
  Widget _buildList(BuildContext context, List<BoardListModel> snapshots) {
    return ListView(
  ...
  Widget _buildListItem(BuildContext context, BoardListModel data) {
    var bordListDetails = data;
